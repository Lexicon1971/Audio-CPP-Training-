    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-lime-400 p-4">
        <div className="bg-white p-12 rounded-3xl shadow-2xl text-center max-w-2xl border border-white/20">
          ...
          <h1 className="text-4xl font-bold text-slate-800 mb-6 font-serif">Child Protection Training</h1>
          <p className="text-slate-600 text-lg mb-10 leading-relaxed">
            Welcome to the interactive training. This self-contained course is designed to prepare you for ministry at Germiston Baptist Church.
          </p>
          <button 
            onClick={startCourse}
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-8 px-4 md:px-8 max-w-5xl mx-auto bg-lime-400 transition-colors duration-500">
      <header className="w-full text-center mb-6">
        ...
        <p className="text-green-900 uppercase tracking-widest text-xs font-black mt-2">Child Protection Training (Offline Mode)</p>
      </header>
          ...
          <>
            {!isQuizStarted ? (
              <div className="p-8 flex flex-col items-center text-center">
                ...
                {/* Teacher's Briefing Box (Replaces Narration) */}
          ...
          <div className="p-16 text-center flex flex-col items-center">
            {isPassed ? (
              <>
                ...
                <p className="text-xl text-slate-600 mb-12 max-w-lg leading-relaxed text-center">Excellent work! You've achieved a perfect score. You have now officially completed the training for the Germiston Baptist Church Child Protection Policy.</p>
              </>
            ) : (
              <>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full max-w-lg justify-center">
              <button onClick={resetCourse} className="flex-1 px-8 py-5 border-4 border-slate-200 text-slate-500 rounded-2xl font-black uppercase tracking-widest hover:bg-slate-50 transition-all hover:border-slate-300 active:scale-95">{isPassed ? 'Review Training' : 'Try Again'}</button>
              {isPassed && (
                <button onClick={exitApp} className="flex-1 px-8 py-5 bg-green-700 text-white rounded-2xl font-black uppercase tracking-widest hover:bg-green-800 transition-all shadow-2xl shadow-green-900/40 active:scale-95 transform hover:-translate-y-1">Training Completed</button>
              )}
            </div>
          </div>
        )}
